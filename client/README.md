...
Browser client for [rtc-bridge](https://github.com/voltrevo/rtc-bridge) — access TCP services directly from the browser over WebRTC, no domain/TLS required on the node.
